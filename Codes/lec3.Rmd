...
anes <- read_delim("/Users/han/Dropbox/Materials/HKUST/Teaching/SOSC5340/sosc5340spring2022/Codes/anes_timeseries_2016_rawdata.txt", delim = "|") %>%
...
```{r}
fixdata = data.frame(wage = c(50, 100, 150,200, 250, 300), education = "5. Advanced Degree", race = "1. White", gender = "Female")
